...
The images in this README are loaded from the `docs/` folder.
...
docs/ams_hero.png
docs/ams_gui.png
docs/chamber_setup.JPG
docs/csv_output.png
docs/polar_output.png
```

GitHub filenames are case-sensitive. For example:
...
The README path must match the real filename exactly.

---

## Project Identity

AMS exists to make antenna measurement more repeatable, visual, and student-friendly.

<p align="center">
  <strong>Windows · Python GUI · VNA control · FS-121 motion · CSV export · polar plots</strong>
</p>
